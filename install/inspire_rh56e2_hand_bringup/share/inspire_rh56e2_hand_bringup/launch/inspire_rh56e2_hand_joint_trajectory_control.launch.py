...
"""
Launch file for Inspire RH56E2 Hand with Joint Trajectory Controller
...
Usage:
  ...
  ros2 launch inspire_rh56e2_hand_bringup inspire_rh56e2_hand_joint_trajectory_control.launch.py serial_port:=/dev/ttyUSB1
...
Or run the Python test script:
  python3 ros2_ws/install/inspire_rh56e2_hand_bringup/share/inspire_rh56e2_hand_bringup/test/test_hand_trajectory.py
...
def launch_setup(context, *args, **kwargs) -> List[Node]:
    ...
    joint_trajectory_config = os.path.join(
        pkg_share, 'config', 'inspire_rh56e2_hand_joint_trajectory_controller.yaml'
    )
    ...
    nodes: List[Node] = [
        ...
        Node(
            ...
            output='screen',
            arguments=[
                'inspire_rh56e2_hand_joint_trajectory_controller',
                '--controller-manager', '/controller_manager',
...
def generate_launch_description() -> LaunchDescription:
    """Generate launch description for Inspire RH56E2 Hand with joint trajectory control."""
    # Declare arguments
